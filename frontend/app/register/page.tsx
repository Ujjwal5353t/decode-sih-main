...
type RegisterRole = "student" | "school" | "parent";
      ...
      <main className="flex-1 flex items-center justify-center p-6 z-10 my-4">
        ...
        >
          ...
          <div className="glass rounded-[var(--radius-xl)] p-8 shadow-[var(--shadow-xl)] border border-border-primary">
            ...
            {/* Role Selector Tabs */}
            <div className="grid grid-cols-3 gap-2 p-1 bg-surface-hover rounded-[var(--radius-md)] mb-6">
              {rolesConfig.map((r) => {
                const Icon = r.icon;
                ...
                return (
                  <button
                    ...
                    className={`flex flex-col items-center gap-1 py-2.5 px-2 rounded-[var(--radius-sm)] text-xs font-medium transition-all cursor-pointer ${
                      isSelected
